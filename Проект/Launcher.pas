...
begin
  ...
  label6.Caption := 'П Р И Я Т Н О Й  ' + #13 + 'И Г Р Ы';
...
begin
   ...
   try
      self.MediaPlayer1.Open();
       ...
       begin
         MessageDlg('Неверный путь к файлу. Возможно его больше не существует. Попробуйте еще.',vcl.Dialogs.mtError, mbOKCancel, 0);
         exit;
       end;
